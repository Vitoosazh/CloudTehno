...
runclk();
for (i = 0; i <= 35; i++) {
document.f[('imGame/img'+i)].src = "0.gif";}}
function runclk() {
...
if (oktoclick) {
oktoclick = false; 
document.f[('imGame/img'+but)].src = ''+map[but]+'.gif';
if (ctr == 0) {
ctr++;
clickarray[0] = but;
oktoclick = true;} else {
...
document.f[('imGame/img'+clickarray[0])].src = "0.gif";
oktoclick = true;} else {
if (map[clickarray[0]] != map[clickarray[1]]) {
if (user[clickarray[0]] == 0) {
document.f[('imGame/img'+clickarray[0])].src = "0.gif";}
if (user[clickarray[1]] == 0) {
document.f[('imGame/img'+clickarray[1])].src = "0.gif";}}
if (map[clickarray[0]] == map[clickarray[1]]) {
...
document.write('<img src="imGame/0.gif" name="img'+((6*r)+c)+'" border="0">');
document.write('</a></td>');}
document.write('</tr>');}